...
//Playlist server (interests)
GET("https://edgemony-backend.herokuapp.com/playlist").then((interests) => {
  interests.map((interests) =>
    createInterestsEl(interestsEl, interests.title, interests.cover)
  );
});

//Film server (interests)
GET("https://edgemony-backend.herokuapp.com/movies").then((movies) => {
  movies.map((movies) =>
    createInterestsEl(interestsEl, movies.title, movies.poster)
  );
});
